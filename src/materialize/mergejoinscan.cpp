...
namespace materialize {
  MergeJoinScan::MergeJoinScan(const std::shared_ptr<scan::Scan>& s1, const std::shared_ptr<SortScan>& s2,
      const std::string& fldname1, const std::string& fldname2) : s1_(s1), s2_(s2), fldname1_(fldname1), fldname2_(fldname2) {
      beforeFirst();
    }
